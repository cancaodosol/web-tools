function show_resut(){
    ...
    var myRadarChart = new Chart(ctx,{
        type:'radar',
        data: {
            labels: ["A 視覚的ワーキングメモリ","B 聴覚的ワーキングメモリ","C 言語操作力","D 数操作力","E 空間認知力","F 処理能力","G 適応力","F こだわり力","I 創造力","J 想像力","K 社会技能力","L 自己コントロール力","M 時間力","N 継続力","O 遂行機能力","P 注意力","Q ボディイメージ","R 視覚的認知力","S 聴覚認知力","T 運動能力"],
            datasets:[{
                label:answer_name,
